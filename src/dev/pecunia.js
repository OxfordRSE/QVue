                                ...
                                extra_answers: [
                                    {
                                        ...
                                        placeholder: "please specify",
                                        validators: [
                                            required_if((ans, item) => item.answers[2].extra_answers[1].content === 3),
                                        ],
                                    },
                                ],
                            },
                                ...
                                extra_answers: [
                                    {
                                        ...
                                        placeholder: "please specify",
                                        validators: [
                                            required_if((ans, item) => item.answers[3].extra_answers[1].content === 4),
                                        ],
                                    },
                                ],
                            },
                ...
                },
                {
                    ...
                    validators: [
                        required_if((ans, item) => {
                            ...
                            return (item.answers[14].content > 0 || item.answers[15].content > 0);
                        }),
                    ],
                },
                {
...
(e.g. learning/physical/developmental disabilities).
            ...
            answers: [
                {
                    ...
                    options: [
                        ...
                        {
                            label: "Yes, in a higher education school (e.g. university, college, vocational school)",
                        },
                        { label: "No" },
                        { label: "I don’t know/I would rather not say" },
                        {
            ...
            next_item_fun: (last_changed_answer) => {
                if ([5, 6].includes(last_changed_answer?.content))
                    return "E6";
                return "E3";
            },
        }),
                    ...
                    extra_answers: [
                        {
                            ...
                            placeholder: "please specify",
                            validators: [
                                required_if((ans, item) => item.answers[3].extra_answers[1].content > 0),
                            ],
                        },
                        {
                            id: "G5.2_other_times",
