...
const new_medication_item = (id) => {
    return new Item({
        id: id,
        question: "Please list below any prescribed medications you have taken in the past 3 months.\n" +
        ...
        answers: [
            ...
            {
                type: AnswerType.NONE,
                label: "For how long have you taken the given medication in the past 3 months?",
                extra_answers: [
...
export const _state_properties = {
    items: [
        ...
        new Item({
            id: "A1",
            question: "A1\tWhere have you lived or stayed overnight (e.g. in hospital) in the past 3 months?\n" +
                "\n" +
                    ...
                    extra_answers: [
                        {
                            id: "A1_hospital_0",
                            type: AnswerType.NUMBER,
                            label: "Type of hospital department/service (e.g. oncology, surgery, psychiatry):",
                            extra_answers: [
        ...
        {
            id: "B1",
            question: "Have you used any non-emergency outpatient/social care services in the past 3 months?\n" +
            ...
            next_item_fun: (last_changed_answer) => {
                if (last_changed_answer?.content === 0)
                    return "B1.2";
                return "B2.1";
            },
        },
        {
            id: "B1.2",
            question: "How many times have you used any of the following non-emergency outpatient/social care services in the past 3 months?\n" +
                "\n" +
            ...
            answers: [
                ...
                {
                    type: AnswerType.NUMBER,
                    label: "Diagnostic laboratory services (e.g. genetic testing, blood tests)",
                    extra_answers: [
                ...
                {
                    type: AnswerType.NUMBER,
                    label: "Other health care (e.g. psychologist, physiotherapist, dietician)",
                    extra_answers: [
                        {
                ...
                {
                    type: AnswerType.NUMBER,
                    label: "Holistic health care (e.g. acupuncturist, homeopathist, Traditional Chinese Medicine (TCM), osteopath)",
                    extra_answers: [
                        {
                            id: "B1.2_alternative",
                            type: AnswerType.TEXT,
        ...
        {
            id: "B2.1",
            question: "B2.1\tHave you used any day care services in the past 3 months?\n" +
        ...
        {
            id: "B2.2",
            question: "B2.2\tHow many times did you use any of the following day care services in the past 3 months?\n" +
        ...
        {
            id: "B3.1",
            question: "Have you participated in any support/self-help groups in the past 3 months?" +
        ...
        {
            id: "B4.1",
            question: "Have you used any emergency care services for yourself in the past 3 months?\n" +
        ...
        new Item({
            id: "D1",
            question: "How many hours of unpaid help (informal care) have you received because of your health in the past 3 months?",
    ...
    onComplete: (state) => {
      ...
      ${items
                .map((i) => `<ul><li>${i.data_id} [${i.id}]</li><li>${i.content}</li><li>${i.label}</li><li>${i.answer_utc_time}</li></ul>`)
                .join("\n")}
      `,
            key_data: {
