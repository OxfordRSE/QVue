...
const panic_navigation = (ans, state) => {
    if (state.getItemById("anxiety").answer?.value === 1 &&
...
export const _state_properties = {
    items: [
        ...
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 2 ? "health-weight-loss" : "health-appetite-gain",
        }),
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 2 ? "health-weight-loss-diet" : "health-gp-visits",
        }),
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "health-weight-loss-amount" : "health-gp-visits",
        }),
        new Item({
        ...
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 2 ? "health-weight-gain-amount" : "health-gp-visits",
        }),
        new Item({
        ...
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "somatic-discomfort" : "somatic-stress",
        }),
        new Item({
            id: "somatic-stress",
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "somatic-discomfort" : "somatic-pain-frequency",
        }),
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "somatic-discomfort" : "somatic-pain-duration",
        }),
        new Item({
        ...
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "fatigue" : "somatic-discomfort-stress",
        }),
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "fatigue" : "somatic-discomfort-frequency",
        }),
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "fatigue" : "somatic-discomfort-long",
        }),
        new Item({
        ...
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "fatigue-energy" : "fatigue-tired-cause",
        }),
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 6 ? "concentration" : "fatigue-tired-frequency",
        }),
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "fatigue-energy" : "fatigue-tired-duration",
        }),
        new Item({
        ...
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "concentration" : "fatigue-energy-cause",
        }),
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 6 ? "concentration" : "fatigue-energy-frequency",
        }),
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "concentration" : "fatigue-energy-duration",
        }),
        new Item({
        ...
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "sleep-gain" : "sleep-loss-frequency",
        }),
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "irritability" : "sleep-loss-time",
        }),
        new Item({
            id: "sleep-loss-time",
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "irritability" : "sleep-loss-long",
        }),
        new Item({
            id: "sleep-loss-long",
        ...
        new Item({
            ...
            next_item_fun: (ans) => ans?.value !== 3 ? "irritability" : "sleep-gain-frequency",
        }),
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "irritability" : "sleep-gain-time",
        }),
        new Item({
            id: "sleep-gain-time",
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "irritability" : "sleep-gain-long",
        }),
        new Item({
            id: "sleep-gain-long",
        ...
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 2 ? "irritability-frequency" : "irritability-trivial",
        }),
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "hypochondria" : "irritability-frequency",
        }),
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "hypochondria" : "irritability-long",
        }),
        new Item({
        ...
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 2 ? "hypochondria-frequency" : "hypochondria-serious",
        }),
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "depression" : "hypochondria-frequency",
        }),
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "depression" : "hypochondria-excessive",
        }),
        new Item({
        ...
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "depression-enjoy" : "depression-recent",
        }),
        new Item({
        ...
        new Item({
            ...
            next_item_fun: (ans, state) => {
                const anx = state.counters.get("anxiety", 0);
                if (state.getItemById("phobia-frequency").answer?.value === 1 &&
                    anx <= 1)
                    return "anxiety-outro";
        ...
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "panic-duration" : "panic-specific",
        }),
        new Item({
            id: "panic-specific",
        ...
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "obsessions" : "compulsions-frequency",
        }),
        new Item({
            ...
            next_item_fun: (ans) => ans?.value === 1 ? "obsessions" : "compulsions-control",
        }),
        new Item({
        ...
        new Item({
            ...
            next_item_fun: (ans, state) => ans?.value === 1
        ...
        new Item({
            ...
            next_item_fun: (ans, state) => ans?.value === 2
                ? _overall_navigation(ans, state)
